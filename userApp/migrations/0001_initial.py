    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('OWNER', 'Owner'), ('STAFF', 'Staff'), ('CLIENT', 'Client')], default='CLIENT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('doc_type', models.CharField(choices=[('contract', 'Contract'), ('payout_statement', 'Payout Statement'), ('other', 'Other')], default='other', max_length=40)),
                ('title', models.CharField(max_length=255)),
                ('description', models.TextField(blank=True)),
                ('file', models.FileField(blank=True, help_text='PDF or image files up to 10MB.', null=True, upload_to=userApp.models.staff_document_upload_to, validators=[django.core.validators.FileExtensionValidator(['pdf', 'jpg', 'jpeg', 'png', 'webp', 'doc', 'docx', 'xls', 'xlsx']), userApp.models.validate_doc_size])),
                ('external_url', models.URLField(blank=True, help_text='Optional external URL (e.g. Google Sheet for payouts).')),
                ('year', models.PositiveIntegerField(blank=True, null=True)),
                ('month', models.PositiveSmallIntegerField(blank=True, help_text='1–12 if applicable', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
